...
export default function Page() {
  return (
    <MotionWrapper>
      ...
      <SectionCard>
        <Stack gap={4}>
          <Heading size="lg">開く前に、ひと呼吸</Heading>
          <Text>
      ...
      <SectionCard>
        <Stack gap={4}>
          <Heading size="lg">引き返した回数を、数えます</Heading>
          <Text>
      ...
      <SectionCard>
        <Stack gap={4}>
          <Heading size="lg">傾向は、答え合わせに</Heading>
          <Text>
            時間帯や曜日の傾向を、事実として返します。「だからやめましょう」とは言いません。結論を出すのは、あなたです。
          </Text>
          <Image
            src="/image/hitomazu-04.png"
      ...
      <SectionCard>
        <Stack gap={4}>
          <Heading size="lg">ブロックしない、と決めています</Heading>
          <Text>
      ...
      <SectionCard>
        <Stack gap={4}>
          <Heading size="lg">サーバーがありません</Heading>
          <Text>
      ...
      <SectionCard>
        <Stack gap={4}>
          ...
          <Text>
            ひとまず Proでできることは3つだけです。見守るアプリを無制限に選べる。問いかけの言葉を自分の言葉にできる。時間帯ごとにひと呼吸の強さを変えられる。
          </Text>
        </Stack>
      </SectionCard>
