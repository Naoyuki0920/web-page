...
export default function Page() {
  return (
    <MotionWrapper>
      <SectionCard>
        <Stack gap={4}>
          <Heading size="2xl">うちの植物 プライバシーポリシー</Heading>
          <Text>
          ...
          <Heading size="lg">記録の保存先</Heading>
          <Text>
          ...
          <Heading size="lg">カメラの利用</Heading>
          <Text>
          ...
          <Heading size="lg">図鑑の情報について</Heading>
          <Text>
